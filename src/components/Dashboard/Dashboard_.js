                                ...
                                <div className='col-12 m-0 p-0 '>
                                    ...
                                    <div className='row m-0 p-0'>
                                            <div className='col-2 d-flex justify-content-end'>
                                                <div className='mt-4'>
                                                    <img src={profile} alt="user profile" className="img-fluid rounded-pill" style={{ height: 40, width: 40 }} />
                                                </div>
                                            </div>
                                            <div className='col-10'>
                                                <div className="form-outline mt-4 dashboard-msg-sender-dev d-flex justify-content-start">
                                        ...
                                        <div className='row'>
                                            <div className='col-2'>
                                                <div className='my-4' style={{ justifyContent: 'end', display: 'flex' }}>
                                                    <img src={profile} alt="user profile" className="img-fluid rounded-pill" style={{ width: 50, height: 50 }} />
                                                </div>
                                            </div>
                                            <div className='col-7'>
