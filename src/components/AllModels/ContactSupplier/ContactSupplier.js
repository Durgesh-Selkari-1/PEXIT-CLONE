                ...
                <div className="modal-dialog" >
                    <div className="modal-content" style={{ backgroundColor: '#585858' }}>
                        <div className="modal-header mb-0 pb-0 border-0">
                            <p className="modal-title m-0 p-0 ms-auto text-light fw-bold" id="exampleModalLabel">Contact Supplier</p>
                                ...
                                <div className='col-12'>
                                    <form className=''>
                                        ...
                                        <div className="mb-3 placeholder-in-create-group-dev">
                                            ...
                                            <input className="form-control form-control-lg" type="tel" pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" placeholder="Phone" aria-label=".form-control-lg example" />
                                        </div>
                                        <div className="mb-3 placeholder-in-create-group-dev">
